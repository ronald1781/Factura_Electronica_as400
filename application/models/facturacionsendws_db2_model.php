...
class Facturacionsendws_db2_model extends CI_Model {
	...
	function get_verificar_existe_fact(){
		...
		$sql ="select a.SCTEFEC,a.SCTECIAA,a.SCTEPDCA,a.SCTESERI,a.SCTECORR from LIBPRDDAT.SNT_CTRAM a where a.SCTCSTST='G' and a.SCTFECEM>='2019-06-01'";

		//$sql ="select a.SCTEFEC,a.SCTECIAA,a.SCTEPDCA,a.SCTESERI,a.SCTECORR from LIBPRDDAT.SNT_CTRAM a where a.SCTEFEC=20190605 and a.SCTCSTS='A' and a.SCTCSTST ='G' and a.SCTETDOC='01' and SCTCFECR=20190604 AND SCTCPGMT='Manual' and  a.SCTCHORR>=83000 and a.SCTCHORR<=125230 ";
...
// +---------------------------------------------------------------------------+       
		function get_anticiporelacionado_fe($data){
			include("application/config/conexdb_db2.php");
			$codcia=$this->session->userdata('codcia');
			$SCTECIAA=$data['SCTECIAA'];
			$SCTESUCA=$data['SCTESUCA'];
$SCTETDOC=$data['SCTETDOC'];
$SCTEPDCA=$data['SCTEPDCA'];
			$data='';
...
// +---------------------------------------------------------------------------+       
		function get_anticipos_fe($dato){
			include("application/config/conexdb_db2.php");
			$SCTECIAA=$dato['SCTECIAA'];
			$SCTESUCA=$dato['SCTESUCA'];
			$SCTEPDCA=$dato['SCTEPDCA'];
			$SCTETDOC=$dato['SCTETDOC'];
